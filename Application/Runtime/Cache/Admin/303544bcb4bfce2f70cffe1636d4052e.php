...
<div style="font-size: 13px;margin: 10px 5px">
    <form action="/index.php/Admin/Goods/upd/goods_id/23.html" method="post" enctype="multipart/form-data">
        ...
        >
            ...
            <tr>
                <td>加入推荐</td>
                <td>
                    <input type="checkbox" name="is_qiang" value='yes'
                    <?php if(($info['is_qiang']) == "yes"): ?>checked='checked'<?php endif; ?>
                    />抢购
                    <input type="checkbox" name="is_hot" value='se'
                    <?php if(($info['is_hot']) == "se"): ?>checked='checked'<?php endif; ?>
                    />热销
                    <input type="checkbox" name="is_rec" value='re'
                    <?php if(($info['is_rec']) == "re"): ?>checked='checked'<?php endif; ?>
                    />推荐
                    <input type="checkbox" name="is_new" value='new'
                    <?php if(($info['is_new']) == "new"): ?>checked='checked'<?php endif; ?>
                    />新品
                </td>
            </tr>
        </table>
